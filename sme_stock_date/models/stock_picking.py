...
class Picking(models.Model):
    ...
    def _check_validity_date(self):
        for stock in self:
            if stock.date_done > fields.Datetime.now() :
                raise exceptions.ValidationError(_('"Effective Date" must be earlier than the current date.'))
    ...
    def action_done(self):
        ...
        if not date : #  by myh@smeintellect.com
