...
class StockMove(models.Model):
    ...
    def _action_done(self, cancel_backorder=False):
        ...
        #V start stock - stock_move action_done
        ...
        self._stock_account_after_action_done(moves_todo, valued_moves) # add to integrate = by myh@smeintellect.com
        ...
        # ^ end stock - stock_move action_done
        return moves_todo
