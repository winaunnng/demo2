odoo.define('sme_stock_ledger.stock_custom_report', function (require) {
'use strict';
...
//                }
    ...
    renderButtons: function() {
        var self = this;
        this.$buttons = $(QWeb.render("stockReportLedger.buttons", {buttons: this.buttons}));
        // bind actions
    ...
    add_edit_footnote: function(e) {
        ...
        var $content = $(QWeb.render('stockReportLedger.footnote_dialog', {text: text, line: line_id}));
        var save = function() {
...
core.action_registry.add('stock_custom_report', stockReportsWidget);
